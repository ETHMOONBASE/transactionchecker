...
function updateGame() {
    if(game.state == "STARTING") {
        ...
        if(game.busted) $("#gameBust").text("Game busted at " + ((game.busted)/100) + "x");
        else $("#gameBust").text("Game busted at " + ((Math.floor(100 * Math.pow(Math.E, 0.00006 * game.elapsed)))/100) + "x");
